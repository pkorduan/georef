...
switch ($this->formvars['action']) {
  ...
  case 'georef' : {
    ...
    $tool = 'gdal_translate';
    $param = '-of GTiff -a_srs EPSG:25833'
...
<div id="map"></div>
  ...
  <div class="coord-box">
    ...
    <div class="headtop">RW</div>
    <div class="headtop">HW</div>
    <div class="headtop">X</div>
    <div class="headtop">Y</div>
    <div class="headtop">dRW</div>
    <div class="headtop">dHW</div>
    <div class="headtop">dX</div>
    <div class="headtop">dY</div>
  </div>
  <div class="clear"></div>
  ...
  <div id="ul_box" class="coord-box focus">
    ...
    <div class="cell"><input id="uldrw"></div>
    <div class="cell"><input id="uldhw"></div>
    <div class="cell"><input id="uldx"></div>
    <div class="cell"><input id="uldy"></div>
  </div>
  <div class="clear"></div>
  ...
  <div id="ur_box" class="coord-box">
    ...
    <div class="cell"><input id="urdrw"></div>
    <div class="cell"><input id="urdhw"></div>
    <div class="cell"><input id="urdx"></div>
    <div class="cell"><input id="urdy"></div>
  </div>
  <div class="clear"></div>
  ...
  <div id="lr_box" class="coord-box">
    ...
    <div class="cell"><input id="lrdrw"></div>
    <div class="cell"><input id="lrdhw"></div>
    <div class="cell"><input id="lrdx"></div>
    <div class="cell"><input id="lrdy"></div>
  </div>
  <div class="clear"></div>
  ...
  <div id="ll_box" class="coord-box">
    ...
    <div class="cell"><input id="lldrw"></div>
    <div class="cell"><input id="lldhw"></div>
    <div class="cell"><input id="lldx"></div>
    <div class="cell"><input id="lldy"></div>
  </div>
  <div class="clear"></div>
